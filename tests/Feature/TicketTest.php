...
test('customer cannot view another customer ticket', function () {
    ...
    $token = $customer2->createToken('Test', [Abilities::ViewTickets])->plainTextToken;
...
test('admin can view all tickets', function () {
    ...
    $token = $admin->createToken('Test', [Abilities::ViewTickets])->plainTextToken;
...
test('customer can delete own open ticket', function () {
    ...
    $token = $customer->createToken('Test', [Abilities::ViewTickets, Abilities::DeleteTicket])->plainTextToken;
